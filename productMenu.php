		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
                                        ...
                                        <option value="equipments" style="color: black;">Equipments</option>
                                        <option value="machinery" style="color: black;">Machinery</option>
                                        <option value="soil" style="color: black;">Soil</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
                    ...
                    if(isset($_GET['type']) AND $_GET['type'] == "equipments")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Equipments'";
					}
                    if(isset($_GET['type']) AND $_GET['type'] == "machinery")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Machinery'";
					}
                    if(isset($_GET['type']) AND $_GET['type'] == "soil")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Soil'";
					}
