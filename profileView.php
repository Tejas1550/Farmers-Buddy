                            ...
                            <center>
                                <div class="row uniform">
                                     <div class="3u 12u$(xsmall)">
            							<a href="password.php" class="btn btn-danger" style="text-decoration: none;">Change Password</a>
            						</div>
                                    ...
                                    <div class="3u 12u$(large)">
                                        <a href="Login/logout.php" class="btn btn-danger" style="text-decoration: none;">Logout</a>
                                    </div>
                                </div>
                            </center>
                        </div>
